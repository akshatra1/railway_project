...
{
    FILE *fp;
    fp=fopen("C:\\MY PROJECT RS\\alltrains.dat","rb");
    if(fp==NULL)
    {
        ...
        fp=fopen("C:\\MY PROJECT RS\\alltrains.dat","wb");
...
void view_trains()
{
    ...
    printf("_ ");
    printf("\n");
    FILE  *fp=fopen("C:\\MY PROJECT RS\\alltrains.dat","rb");
    Train tr;
    textcolor(15);
...
int get_booked_ticket_count(char*train_no,char c)
{
    Passenger pr;
    int count=0;
    FILE*fp=fopen("C:\\MY PROJECT RS\\allbookings.dat","rb");
    if(fp==NULL)
    {
        return 0;
    }
...
int book_ticket(Passenger p)
{
    ...
    FILE *fp=fopen("C:\\MY PROJECT RS\\allbookings.dat","ab");
    if(fp==NULL)
    {
        textcolor(12);
...
void view_ticket(int ticket_no)
{
    clrscr();
    FILE*fp=fopen("C:\\MY PROJECT RS\\allbookings.dat","rb");
    FILE *fp1=fopen("C:\\MY PROJECT RS\\alltrains.dat","rb");
    if(fp==NULL)
    {
        textcolor(12);
...
{
    FILE*fp1=fopen("C:\\MY PROJECT RS\\allbookings.dat","rb");
    if(fp1==NULL)
    {
        textcolor(12);
        printf("\nNo bookings done yet");
     ...
     FILE*fp2=fopen("C:\\MY PROJECT RS\\temp.dat","wb+");
     Passenger pr;
     int found=0;
     ...
     if(found==0)
     {
         remove("C:\\MY PROJECT RS\\temp.dat");
     }
     else
     {
        remove("C:\\MY PROJECT RS\\allbookings.dat");
        rename("C:\\MY PROJECT RS\\temp.dat","C:\\MY PROJECT RS\\allbookings.dat");
     }
   return found;
}
char* accept_mob_no()
...
int* get_ticket_no(char *p_mob_no)
{
    int count=0;
    FILE *fp;
    fp=fopen("C:\\MY PROJECT RS\\allbookings.dat","rb");
    if(fp==NULL)
    {
        return NULL;
    }
...
int cancel_train(char *train_no)
{
    ...
    if(fp1==NULL)
    {
     ...
     FILE*fp2=fopen("C:\\MY PROJECT RS\\data.dat","wb+");
     Passenger pr;
     int found=0;
     while(fread(&pr,sizeof(pr),1,fp1)==1)
     {
     ...
     if(found==0)
     {
         remove("C:\\MY PROJECT RS\\data.dat");
     }
     else
     {
        remove("C:\\MY PROJECT RS\\allbookings.dat");
        rename("C:\\MY PROJECT RS\\data.dat","C:\\MY PROJECT RS\\allbookings.dat");
     }
return found;
clrscr();
}
